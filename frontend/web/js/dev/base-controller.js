    ...
    this.initTinymce = function (selector, height, readonly) {
        ...
        tinymce.init({
            ...
            plugins: [
                ...
                "insertdatetime media table contextmenu paste textcolor gallery"
            ],
            toolbar: "fontselect | fontsizeselect | styleselect | bold italic underline | forecolor backcolor | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent | link image | imageupload | gallery",
