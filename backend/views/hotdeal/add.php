    ...
    <div style="width: 680px; margin: auto; margin-top: 10px;">
        <?php if (Yii::$app->getSession()->hasFlash('success')) { ?>
            <div class="alert alert-success" role="alert">
                <span class="glyphicon glyphicon-exclamation-sign" aria-hidden="true"></span> Thêm mới thành công 
            </div>
        <?php } else if (Yii::$app->getSession()->hasFlash('error')) { ?>
            <div class="alert alert-danger" role="alert">
                <span class="glyphicon glyphicon-exclamation-sign" aria-hidden="true"></span> Thêm mới thất bại
            </div>
        <?php } ?>
